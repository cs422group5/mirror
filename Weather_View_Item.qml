...
Component {
    ...
    Item {
        ...
        Text { x: 80; y: 17; text:weather_view.temperature_f?low+" - "+high:Wfunc.ftoc(low)+" - "+Wfunc.ftoc(high); font.family: "Arial"; font.pixelSize: 12; elide: Text.ElideRight; color: "#ffffff"; style: Text.Raised; styleColor: "black" }
